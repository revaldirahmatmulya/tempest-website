var OrgChart = function (t, e) {
  var r = this;
  if (((this.element = t), (this.config = OrgChart._defaultConfig()), e))
...
(OrgChart._defaultConfig = function () {
    ...
    this.manager.read(
      ...
      function (t) {
        m != OrgChart.action.exporting &&
          ((x.nodes = t.nodes),
          (x.visibleNodeIds = t.visibleNodeIds),
          (x.roots = t.roots)),
        ...
        for (o = 0; o < t.visibleNodeIds.length; o++) {
          ...
          (r += x.ui.link(l, x, i, t.bordersByRootIdAndLevel, t.nodes, m)),
            (r += x.ui.expandCollapseBtn(x, l, x._layoutConfigs, m, i));
        }
        e = { content: r, res: t };
        if (
          ...
          (m !== OrgChart.action.centerNode &&
            m !== OrgChart.action.insert &&
            m !== OrgChart.action.expand &&
            m !== OrgChart.action.collapse &&
            m !== OrgChart.action.update) ||
            (n = a),
          ...
          if (x._initialized) {
            ...
            (x.element.innerHTML =
              x.ui.css() + x.ui.exportMenuButton(x.config) + C),
  ...
  (OrgChart.prototype._nodeHasHiddenParent = function (t) {
    return !t.parent && !OrgChart.isNullOrEmpty(t.pid) && this.getNode(t.pid);
  }),
        ...
        for (var t = 0; t < c.length; t++)
          for (var e in p[t]) {
            ...
            switch (e.toLowerCase()) {
              case "d":
                var i =
                    u((10 * y - 10) / f) * (p[t][e][0] - g[t][e][0]) +
                    g[t][e][0],
                  a =
                    u((10 * y - 10) / f) * (p[t][e][1] - g[t][e][1]) +
                    g[t][e][1];
                c[t].setAttribute(
                  "d",
              ...
              case "r":
                ...
                break;
              case "x1":
                (n = u((10 * y - 10) / f) * (p[t][e] - g[t][e]) + g[t][e]),
                  c[t].setAttribute("x1", n);
                break;
              case "x2":
                (n = u((10 * y - 10) / f) * (p[t][e] - g[t][e]) + g[t][e]),
                  c[t].setAttribute("x2", n);
                break;
              case "y1":
                (n = u((10 * y - 10) / f) * (p[t][e] - g[t][e]) + g[t][e]),
                  c[t].setAttribute("y1", n);
                break;
              case "y2":
                (n = u((10 * y - 10) / f) * (p[t][e] - g[t][e]) + g[t][e]),
                  c[t].setAttribute("y2", n);
                break;
              case "rotate3d":
                if (p[t][e]) {
                  var o = g[t][e],
  ...
  (OrgChart.attr.search_item_id = "data-search-item-id"),
  ...
  (OrgChart.input = function (t, e, r, i, a, n) {
    ...
    if (
      ...
      o.setAttribute(OrgChart.attr.field_name, t),
      ...
      (s.style.width = "100%"),
      s.setAttribute(OrgChart.attr.val, ""),
      a && (s.style.width = "80%"),
      ...
      l.setAttribute(OrgChart.attr.lbl, ""),
  ...
  (OrgChart.editUI.prototype._createEditView = function (t, e) {
    ...
    var s = OrgChart._arrayContains(this.node.tags, "assistant")
      ? "checked"
      : "";
    l.setAttribute(OrgChart.attr.field_name, "isAssistant"),
      (l.innerHTML =
  ...
  (OrgChart.editUI.prototype.hide = function (t) {
    if (this.wrapperElement) {
      ...
      if (t) {
        for (
          var r = this.wrapperElement.querySelectorAll(
              "[" + OrgChart.attr.field_name + "]"
            ),
            i = 0;
          i < r.length;
          i++
        ) {
          var a = r[i].getAttribute(OrgChart.attr.field_name);
          if (a) {
            var n = r[i].querySelector("[" + OrgChart.attr.val + "]");
            if (n) {
              var o = n.value;
              if (a === OrgChart.TAGS) e.tags = o.split(",");
              else if ("isAssistant" === a) {
                var l = r[i].querySelector(
                  "[" + OrgChart.attr.val + "]"
                ).checked;
                l && e.tags
        ...
        this.obj._hideBeforeAnimation(),
          OrgChart.anim(
            ...
            OrgChart.anim.inOutSin,
            function () {
              s.obj._showAfterAnimation(),
                s.obj.updateNode(e, null, !0),
                s.obj.element.removeChild(s.wrapperElement),
                (s.wrapperElement = null);
            }
          );
      } else
      ...
      for (
        ...
        (a = f[u]).addEventListener("mouseover", function () {
          ...
          a.addEventListener("click", function (t) {
            var e,
              r = this.getAttribute(OrgChart.attr.item);
  ...
  (OrgChart.circleMenuUI.prototype._show = function (t, e) {
    var i = this,
      r = this.obj.getNode(t),
      a = OrgChart.t(r.templateName, r.min, this.obj.getScale());
    if (!OrgChart.isNullOrEmpty(a.nodeCircleMenuButton)) {
      ...
      if (
        ...
        for (
          var C = 0,
            ...
            y = 2 * Math.PI * O,
            x = y / m - (2 * a.nodeCircleMenuButton.radius + 2);
          x < 0;
        ...
        for (var v in ((p = document.createElementNS(
          "http://www.w3.org/2000/svg",
          "g"
        ...
        f.menu)) {
          ...
          k.setAttribute("transform", "matrix(1,0,0,1,0,0)"),
            k.setAttribute(OrgChart.attr.control_node_circle_menu_name, v),
            (k.style.cursor = "pointer");
          var S = document.createElementNS(
            "http://www.w3.org/2000/svg",
            "title"
          );
          OrgChart.isNullOrEmpty(w) || (S.innerHTML = w);
          ...
          if ((A.setAttribute("pointer-events", "none"), A)) {
            ...
            A.setAttribute("x", -E / 2), A.setAttribute("y", -M / 2);
          }
          var N = (C * Math.PI) / (m / 2);
          C++;
          var L = Math.cos(N) * O,
            ...
            OrgChart.anim(
              ...
              function (t) {
                var e = t[0].getAttribute(
                  ...
                  r = t[0].parentNode.getAttribute(
                    OrgChart.attr.control_node_circle_menu_wrraper_id
                  );
                t[0].addEventListener("mouseenter", function (t) {
                  OrgChart.events.publish("mouseenter", [
                    i,
                    { from: r, menuItem: f.menu[e], menuItemName: e, event: t },
                  ]);
                }),
  ...
  (OrgChart.circleMenuUI.prototype.hide = function () {
    for (var t = this._buttonsInterval.length - 1; 0 <= t; t--)
      clearInterval(this._buttonsInterval[t]),
        this._buttonsInterval.splice(t, 1);
    this._buttonsInterval = [];
    for (t = this._linesInterval.length - 1; 0 <= t; t--)
  ...
  (OrgChart.prototype._pagesA100 = function (t, e, r) {
    ...
    for (
      var g = d.w * (100 / r), p = d.h * (100 / r), f = o, u = l, C = [];
      f < s + o;
  ...
  (OrgChart.prototype._upHandler = function (t) {
    ...
    if (r) {
      r.push(e.pid);
      var i = r.indexOf(e.id);
      -1 != i && r.splice(i, 1);
    } else r = [e.pid];
    var a = { id: e.id, roots: r };
    if (!1 === OrgChart.events.publish("up-click", [this, a])) return !1;
    this.changeRoots(a.id, a.roots, !1);
  }),
  ...
  (OrgChart.prototype._globalClickHandler = function (t, e) {
    ...
    for (var s = e.target; s != t; ) {
      if (s.hasAttribute(OrgChart.attr.control_expcoll_id)) {
        var h = s.getAttribute(OrgChart.attr.control_expcoll_id),
          d = this.getNode(h);
        return void this._expCollHandler(d.id);
      }
      if (s.hasAttribute(OrgChart.attr.node_id)) {
        (h = s.getAttribute(OrgChart.attr.node_id)), (d = this.getNode(h));
        return void this._nodeClickHandler(d.id, e);
      }
      if (s.hasAttribute(OrgChart.attr.control_node_menu_id)) {
        e.stopPropagation(), e.preventDefault();
        (h = s.getAttribute(OrgChart.attr.control_node_menu_id)),
          (d = this.getNode(h));
        return void this._nodeMenuClickHandler(d.id, s, e);
      }
      if (s.hasAttribute(OrgChart.attr.control_node_circle_menu_id)) {
        e.stopPropagation(), e.preventDefault();
        h = s.getAttribute(OrgChart.attr.control_node_circle_menu_id);
        return void this._nodeCircleMenuClickHandler(h);
      }
      if (s.hasAttribute(OrgChart.attr.control_node_circle_menu_name))
        return (
          e.stopPropagation(),
          e.preventDefault(),
          void this._nodeCircleMenuItemClickHandler(s, e)
        );
      if (s.hasAttribute(OrgChart.attr.control_add))
        return void this._lonelyButtonHandler();
      if (s.hasAttribute(OrgChart.attr.control_up_id)) {
        h = s.getAttribute(OrgChart.attr.control_up_id);
        return e.stopPropagation(), e.preventDefault(), void this._upHandler(h);
      }
      if (s.hasAttribute(OrgChart.attr.c_link_from))
        return void OrgChart.events.publish("clink-click", [
          this,
          {
            from: s.getAttribute(OrgChart.attr.c_link_from),
            to: s.getAttribute(OrgChart.attr.c_link_to),
            event: e,
          },
        ]);
      if (s.hasAttribute(OrgChart.attr.s_link_from))
        return void OrgChart.events.publish("slink-click", [
          this,
          {
            from: s.getAttribute(OrgChart.attr.s_link_from),
            to: s.getAttribute(OrgChart.attr.s_link_to),
            event: e,
          },
        ]);
      s = s.parentNode;
  ...
  (OrgChart.prototype._nodeCircleNodeMenuItemMouseDownHandler = function (
    ...
    var e = O.parentNode.getAttribute(
        OrgChart.attr.control_node_circle_menu_wrraper_id
      ),
      y = O.getAttribute(OrgChart.attr.control_node_circle_menu_name),
      x = this.nodeCircleMenuUI._menu[y];
    if (x.draggable) {
      var v = this,
        i = OrgChart._getClientXY(t),
        a = this.getNode(e);
      O._dragEventFired = !1;
      var b = v.getScale(),
        _ = null,
        w = null;
      (this._gragStartedId = e),
      ...
      var A = OrgChart._getTransform(I),
        E = A[4],
        M = A[5],
        N = (function (t) {
          for (
      ...
      var L = function (t, e) {
          if (null != t) {
            ...
            for (
              var r = OrgChart.getStParentNodes(v.getNode(_)), i = 0;
              i < r.length;
              i++
            ) {
              var a = v.getNodeElement(r[i].id);
              a && (a.style.opacity = 1);
            }
          }
        },
        n = function (t) {
          if (S) {
            var e = OrgChart._getClientXY(t),
              r = t.target;
            (e.x += N.x * b), (e.y += N.y * b);
            var i = OrgChart._getOffsetXY(v.element, t),
              a = {
                left: v.width() - (i.x + v.config.padding) < 0,
                right: i.x - v.config.padding < 0,
                down: v.height() - (i.y + v.config.padding) < 0,
                up: i.y - v.config.padding < 0,
              };
            if (a.left || a.right || a.up || a.down) {
              k.classList &&
                (k.classList.remove("cursor-grab"),
                k.classList.add("cursor-move"),
                k.classList.remove("cursor-nodrop"),
                k.classList.remove("cursor-copy"));
              var n = A[4],
                o = A[5],
                l = S.x,
                s = S.y,
                h = e.x,
                d = e.y;
              v.startMove(a, function (t) {
                (A[4] = n + t.x),
                  (A[5] = o + t.y),
                  (S.x = l - t.xWithoutScale),
                  (S.y = s - t.yWithoutScale),
                  (e.x = h - t.xWithoutScale),
                  (e.y = d - t.yWithoutScale),
                  I.setAttribute("transform", "matrix(" + A.toString() + ")");
              });
            } else {
              for (
                v.stopMove(),
                  k.classList &&
                    (k.classList.add("cursor-grab"),
                    k.classList.remove("cursor-move"),
                    k.classList.remove("cursor-nodrop"),
                    k.classList.remove("cursor-copy")),
                  L(_, w),
                  w = _ = null;
                ...
                if (r.hasAttribute && r.hasAttribute(OrgChart.attr.node_id)) {
                  var c = r.getAttribute(OrgChart.attr.node_id);
                  (_ = c), (w = r);
                  break;
                }
                r = r.parentNode;
              ...
              if (null != _) {
                ...
                for (
                  var g = v.getNode(_), p = OrgChart.getStParentNodes(g), f = 0;
                  f < p.length;
                  f++
                ) {
                  var u = v.getNodeElement(p[f].id);
                  u && (u.style.opacity = 0.1);
                }
                k.classList.remove("cursor-grab"),
                  k.classList.remove("cursor-move"),
                  k.classList.add("cursor-copy"),
                  k.classList.remove("cursor-nodrop");
              }
              var C = (e.x - S.x) / b,
                m = (e.y - S.y) / b;
              if (
                ...
                (A[5] = M + m),
                !O._dragEventFired &&
                  (Math.abs(e.x - S.x) > OrgChart.FIRE_DRAG_NOT_CLICK_IF_MOVE ||
                    Math.abs(e.y - S.y) > OrgChart.FIRE_DRAG_NOT_CLICK_IF_MOVE))
              )
                !1 ===
                  OrgChart.events.publish("drag", [
                    v.nodeCircleMenuUI,
                    { from: c, menuItem: x, menuItemName: y },
                  ]) && T(),
                  (O._dragEventFired = !0);
              I.setAttribute("transform", "matrix(" + A.toString() + ")");
            }
        ...
        T = function (t) {
          if (
            ...
            k.classList &&
              ...
              k.classList.remove("cursor-nodrop"),
              k.classList.remove("cursor-copy")),
            k.removeEventListener(r.move, n),
            k.removeEventListener(r.up, T),
            r.leave && k.removeEventListener(r.leave, T),
            a.id == _ || null == _)
          )
            return (
              k.removeChild(I),
              (v._gragStartedId = null),
              void (
                O._dragEventFired &&
                OrgChart.events.publish("drop", [
                  v.nodeCircleMenuUI,
                  { from: a.id, menuItemName: y, menuItem: x },
                ])
              )
            );
          var e = v.getNode(_);
          OrgChart.events.publish("drop", [
            v.nodeCircleMenuUI,
            { from: a.id, to: e.id, menuItem: x, menuItemName: y },
          ]),
            L(_, w),
            k.removeChild(I),
            (v._gragStartedId = null);
        };
      k.addEventListener(r.move, n),
        k.addEventListener(r.up, T),
        r.leave && k.addEventListener(r.leave, T);
    }
  }),
  (OrgChart.prototype._nodeMouseDownHandler = function (O, t, i) {
    if (this.config.enableDragDrop) {
      var e = OrgChart._getClientXY(t),
        r = O.getAttribute(OrgChart.attr.node_id),
        y = this.getNode(r);
      O._dragEventFired = !1;
      var x = null,
        v = null;
      ...
      var b = this,
        ...
        A = b.getScale(),
        E = O.cloneNode(!0);
      _.insertBefore(E, _.firstChild), (E.style.opacity = 0.7);
      var M = function (t, e) {
          if (null != t) {
            e.classList.remove("drag-over");
            for (
              var r = b.getNode(x), i = OrgChart.getStParentNodes(r), a = 0;
              a < i.length;
              a++
            ) {
        ...
        a = function (t) {
          if (w) {
            ...
            if (a.left || a.right || a.up || a.down) {
              _.classList &&
                (_.classList.remove("cursor-grab"),
                _.classList.add("cursor-move"),
                _.classList.remove("cursor-nodrop"),
                _.classList.remove("cursor-copy"));
              var n = k[4],
                o = k[5],
                l = w.x,
                s = w.y,
              ...
              if (
                (b.stopMove(),
                _.classList &&
                  (_.classList.add("cursor-grab"),
                  _.classList.remove("cursor-move"),
                  _.classList.remove("cursor-nodrop"),
                  _.classList.remove("cursor-copy")),
                M(x, v),
                (v = x = null),
              ...
              if (null != x) {
                ...
                for (
                  var g = b.getNode(x), p = OrgChart.getStParentNodes(g), f = 0;
                  f < p.length;
                  f++
                ) {
                ...
                !b._canUpdateLink(y.id, x) && _.classList
                  ? (_.classList.remove("cursor-grab"),
                    _.classList.remove("cursor-move"),
                    _.classList.remove("cursor-copy"),
                    _.classList.add("cursor-nodrop"))
                  : _.classList &&
                    (_.classList.remove("cursor-grab"),
                    _.classList.remove("cursor-move"),
                    _.classList.add("cursor-copy"),
                    _.classList.remove("cursor-nodrop"));
              }
              var C = (e.x - w.x) / A,
                m = (e.y - w.y) / A;
              if (
                ...
                (k[5] = I + m),
                !O._dragEventFired &&
                  (Math.abs(e.x - w.x) > OrgChart.FIRE_DRAG_NOT_CLICK_IF_MOVE ||
                    Math.abs(e.y - w.y) > OrgChart.FIRE_DRAG_NOT_CLICK_IF_MOVE))
              )
                !1 === OrgChart.events.publish("drag", [b, c]) && N(),
                  (O._dragEventFired = !0);
              E.setAttribute("transform", "matrix(" + k.toString() + ")");
            }
          }
        ...
        N = function (t) {
          if (
            ...
            _.classList &&
              ...
              _.classList.remove("cursor-nodrop"),
              _.classList.remove("cursor-copy")),
            _.removeEventListener(i.move, a),
            _.removeEventListener(i.up, N),
            i.leave && _.removeEventListener(i.leave, N),
            y.id != x && null != x)
          ) {
            var e = b.getNode(x);
            if (!1 === OrgChart.events.publish("drop", [b, y.id, e.id]))
              return M(x, v), _.removeChild(E), void (b._gragStartedId = null);
            if (b._canUpdateLink(y.id, x)) {
              var r = b.get(y.id);
              (r.pid = x), (r.stpid = null), b.updateNode(r, null, !0);
            } else _.removeChild(E), M(x, v);
            b._gragStartedId = null;
          } else {
            _.removeChild(E), (b._gragStartedId = null);
            OrgChart._getClientXY(t);
            O._dragEventFired && OrgChart.events.publish("drop", [b, y.id]);
          }
        };
      _.addEventListener(i.move, a),
        _.addEventListener(i.up, N),
        i.leave && _.addEventListener(i.leave, N);
    }
  }),
  ...
  (OrgChart.searchUI.prototype.hide = function () {
    var t = this.obj.element.querySelector(
      "[" + OrgChart.attr.id + '="search"]'
    );
    if (t) {
      var e = t.querySelector("[" + OrgChart.attr.id + '="cell-1"]'),
  ...
  (OrgChart.searchUI.prototype.show = function (t) {
    var e = this.obj.element.querySelector(
      ...
      r = e.querySelector("[" + OrgChart.attr.id + '="cell-1"]');
  ...
  (OrgChart.searchUI.prototype.addSearchControl = function () {
    ...
    var e = this.obj.element.querySelector(
        "[" + OrgChart.attr.id + '="search-icon"]'
      ),
      a = this.obj.element.querySelector("[" + OrgChart.attr.id + '="search"]'),
      r = this.obj.element.getElementsByTagName("input")[0];
    ...
    var n = function () {
        var t = a.querySelectorAll("[" + OrgChart.attr.search_item_id + "]"),
      ...
      l = function () {
        ...
        if (t) {
          var e = t.getAttribute(OrgChart.attr.search_item_id),
  ...
  (OrgChart.searchUI.prototype._serverSearch = function (t) {
    for (
      var e = this,
        r = this.obj.element.querySelector(
          "[" + OrgChart.attr.id + '="container"]'
        ),
        i = this.obj.element.querySelector(
          "[" + OrgChart.attr.id + '="search"]'
    ...
    r.innerHTML = o;
    var p = i.querySelectorAll("[" + OrgChart.attr.search_item_id + "]");
    for (l = 0; l < p.length; l++)
      p[l].addEventListener("click", function () {
        var t = OrgChart.events.publish("searchclick", [
          e.obj,
          this.getAttribute(OrgChart.attr.search_item_id),
        ]);
        (null != t && 1 != t) ||
          e.obj.center(this.getAttribute(OrgChart.attr.search_item_id));
      }),
  ...
  (OrgChart.searchUI.createInputField = function (t) {
    return (
      "<div " +
      OrgChart.attr.id +
      '="search" style="display:none;border-radius: 20px 20px;padding:5px; box-shadow: #808080 0px 1px 2px 0px; font-family:Roboto-Regular, Helvetica;color:#7a7a7a;font-size:14px;border:1px solid #d7d7d7;width:300px;position:absolute;top:' +
      t +
      "px;left:" +
      t +
      ...
      "</div><div " +
      OrgChart.attr.id +
      '="cell-1" style="float:right; width:83%"><input title="' +
      OrgChart.SEARCH_PLACEHOLDER +
      '" placeholder="' +
      OrgChart.SEARCH_PLACEHOLDER +
      '" style="font-size:14px;font-family:Roboto-Regular, Helvetica;color:#7a7a7a;width:98%;border:none;outline:none; padding-top:10px;" type="text" /></div><div style="clear:both;"></div></div><div ' +
      OrgChart.attr.id +
      '="container"></div></div>'
    );
  }),
  ...
  (OrgChart.searchUI.createSearchIcon = function (t) {
    return (
      "<div " +
      OrgChart.attr.id +
      '="search-icon" style="padding:5px; position:absolute;top:' +
      t +
      "px;left:" +
      t +
  ...
  (OrgChart.manager.prototype.read = function (h, d, c, g, p, f, u, C) {
    var m = this;
    OrgChart.state._get(this.config.state, d, c, function (t) {
      (m.state = t),
        (m.action = p),
        (m.actionParams = f),
        p != OrgChart.action.init ||
        !m.state ||
        (f && f.method && "fit" == f.method)
          ? ((m.viewBox = g), (m.vbIsInitializedFromState = !1))
          : ((m.viewBox = m.state.vb), (m.vbIsInitializedFromState = !0));
      var r = m.maxX,
        i = m.maxY,
        a = m.minX,
        n = m.minY,
        ...
        s = m.nodes;
      if (h) {
        var e = OrgChart.manager._getResponse(
          d,
          c,
          m.visibleNodeIds,
          m.config,
        ...
        p != OrgChart.action.exporting &&
          ...
          (m.roots = l),
          (m.nodes = s),
          (m.visibleNodeIds = e.visibleNodeIds)),
          ...
          m._read(function (t) {
            ...
            (e.notif = t.limit),
              ...
              p != OrgChart.action.exporting &&
                ...
                (m.nodes = s),
                (m.visibleNodeIds = e.visibleNodeIds),
                (m.bordersByRootIdAndLevel = o)),
              u(e);
          }, C);
    });
  }),
  (OrgChart.manager.prototype._read = function (n, t) {
    var o = this,
      e = OrgChart.manager._createNodes(
        o.config,
        o.layoutConfigs,
        o.action,
        o.actionParams,
    ...
    null == r && (r = OrgChart.local),
      r._setPositions(
        ...
        o.layoutConfigs,
        function (t) {
          var e = OrgChart.manager._doNotChangePositionOfClickedNodeIfAny(
            s,
            l,
            o.action,
            o.actionParams,
  ...
  (OrgChart.manager._setCollpasedProperty = function (t, e, r, i, a, n, o) {
    t.parent && null == t.collapsed && e.collapse && e.collapse.allChildren
      ? (t.collapsed = !0)
  ...
  (OrgChart.manager._initNode = function (t, e, r, i, a, n, o, l, s, h, d) {
    var c = n[r || "base"];
    null == t.parent &&
      OrgChart.manager._setCollpasedProperty(t, c, s, l, a, i - 1, d);
    for (var g = 0; g < t.childrenIds.length; g++) {
      var p = e[t.childrenIds[g]];
      if (
        (OrgChart.manager._setCollpasedProperty(p, c, s, l, a, i, d),
        !p.collapsed)
      ) {
    ...
    (t.w = u && u.size ? u.size[0] : 0),
      ...
      null != i && (t.level = i),
      r && (t.lcn = r);
    var C = OrgChart._getSubLevels(t.tags, o.tags);
    0 < C && (t.subLevels = C),
  ...
  (OrgChart.manager._iterate = function (
    ...
    if (
      (OrgChart.manager._initNode(e, r, s, i, c, h, d, g, p, f, u),
      ...
      if (
        ...
        for (
          var C = [], m = 0, O = 0, y = 0;
          y < e.parent.children.length;
          y++
        ) {
          -1 == (x = e.parent.children[y]).tags.indexOf("partner") &&
          -1 == x.tags.indexOf("left-partner") &&
          -1 == x.tags.indexOf("right-partner") &&
          -1 == x.tags.indexOf("assistant") &&
          0 == x.children.length
            ? C.push(x.id)
            : -1 != x.tags.indexOf("assistant")
            ? m++
            : (-1 == x.tags.indexOf("partner") &&
                -1 == x.tags.indexOf("left-partner") &&
                -1 == x.tags.indexOf("right-partner")) ||
              O++;
        }
        ...
        1 < C.length &&
        C.length == e.parent.children.length - m - O
          ? (l[e.pid] = C)
          : !OrgChart.MIXED_LAYOUT_ALL_NODES && 1 < C.length && (l[e.pid] = C);
      }
    } else if (
      !e.isAssistant &&
      ...
      for (C = [], m = 0, O = 0, y = 0; y < e.parent.children.length; y++) {
        var x;
        -1 == (x = e.parent.children[y]).tags.indexOf("partner") &&
        -1 == x.tags.indexOf("left-partner") &&
        -1 == x.tags.indexOf("right-partner") &&
        -1 == x.tags.indexOf("assistant") &&
        0 == x.childrenIds.length
          ? C.push(x.id)
          : -1 != x.tags.indexOf("assistant")
          ? m++
          : (-1 == x.tags.indexOf("partner") &&
      ...
      OrgChart.MIXED_LAYOUT_ALL_NODES &&
      1 < C.length &&
      C.length == e.parent.childrenIds.length - m - O
        ? (l[e.pid] = C)
        : !OrgChart.MIXED_LAYOUT_ALL_NODES && 1 < C.length && (l[e.pid] = C);
    }
    e.stChildren.length &&
  ...
  (OrgChart.manager.__createNodes = function (a, t, n, e, r, i) {
    for (var o = n.nodes, l = [], s = 0; s < o.length; s++) {
      var h,
        d = o[s];
      h = OrgChart.STRING_TAGS
        ? d.tags
          ? d.tags.split(",")
          : []
        ...
        ? d.tags.slice(0)
        : [];
      var c = OrgChart._getTemplate(h, n.tags, n.template),
        g = new OrgChart.node(d.id, d.pid, h, c);
      OrgChart.isNullOrEmpty(d.ppid) || (g.ppid = d.ppid),
        OrgChart.isNullOrEmpty(d.stpid) || (g.stpid = d.stpid),
        null != n.orderBy &&
          (g.order = OrgChart.manager._getOrderFieldValue(d, n.orderBy)),
        (a[d.id] = g),
        l.push(d.id);
    }
    null != n.orderBy &&
      l.sort(function (t, e) {
        ...
        return "number" == typeof r || "number" == typeof i
          ? (null == r && (r = -1),
            null == i && (i = -1),
            n.orderBy.desc ? i - r : r - i)
          : "string" == typeof r || "string" == typeof i
          ? (null == r && (r = ""),
            null == i && (i = ""),
            n.orderBy.desc ? i.localeCompare(r) : r.localeCompare(i))
          : void 0;
      });
    for (s = 0; s < l.length; s++) {
      var p = l[s],
        ...
        u = a[g.stpid],
        C = a[g.pid];
      if ((u || (g.stpid = null), C || (g.pid = null), u)) {
        var m = i ? i[u.id] : null;
        m && (u.min = m.min), u.stChildrenIds.push(g.id);
      } else
        C
          ? (f && ((g.collapsed = f.collapsed), (g.min = f.min)),
            C.childrenIds.push(g.id))
          : (f && ((g.collapsed = f.collapsed), (g.min = f.min)), t.push(g));
      e == OrgChart.action.init && (g.min = OrgChart._getMin(g, n));
    }
  }),
  (OrgChart.manager._createNodes = function (t, e, r, i, a, n) {
    var o = {},
      l = [];
    if ((OrgChart.manager.__createNodes(o, l, t, r, i, a), null != t.roots)) {
      l = [];
      for (var s = 0; s < t.roots.length; s++) {
        var h = o[t.roots[s]];
        if (h && r == OrgChart.action.centerNode) {
          for (var d = h; null != d.pid || null != d.stpid; )
            d = null == d.pid && null != d.stpid ? o[d.stpid] : o[d.pid];
          for (var c = o[i.id]; null != c.pid || null != c.stpid; )
            c = null == c.pid && null != c.stpid ? o[c.stpid] : o[c.pid];
          d == c && (h = d);
        }
        if (h) {
          ...
          if (!g) {
            if (!OrgChart.isNullOrEmpty(h.pid))
              -1 < (B = (K = o[h.pid]).childrenIds.indexOf(h.id)) &&
                K.childrenIds.splice(B, 1);
            l.push(h);
          }
        }
      }
      t.roots = [];
      for (s = 0; s < l.length; s++) t.roots.push(l[s].id);
    }
    ...
    if (r == OrgChart.action.init && t.expand && t.expand.nodes && null == n)
      for (s = 0; s < t.expand.nodes.length; s++) {
        var u = o[t.expand.nodes[s]];
        for (
          !0 === t.expand.allChildren &&
          OrgChart.manager._addExpandedNodeIdsIterate(u, o, f);
          u;
      ...
      for (var C = o[i.id]; C; ) {
        if (
          (f.push(C.id),
          i.options.parentState === OrgChart.COLLAPSE_PARENT_NEIGHBORS && C)
        )
          for (s = 0; s < C.childrenIds.length; s++) {
            (T = o[C.childrenIds[s]]).collapsed = !0;
          }
      ...
      if (i.options.childrenState === OrgChart.COLLAPSE_SUB_CHILDRENS)
        for (s = 0; s < C.childrenIds.length; s++) {
          (O = o[C.childrenIds[s]]).collapsed = !1;
          for (var m = 0; m < O.childrenIds.length; m++) {
            o[O.childrenIds[m]].collapsed = !0;
          }
        }
      if (
        ...
        if ((K = o[C.pid]))
          for (s = 0; s < K.childrenIds.length; s++) {
            var O;
            if ((O = o[K.childrenIds[s]]) != C) {
              O.collapsed = !1;
              for (m = 0; m < O.childrenIds.length; m++) {
                o[O.childrenIds[m]].collapsed = !0;
              }
            }
          }
    } else if (r == OrgChart.action.insert)
      for (u = o[i.insertedNodeId]; u; )
        f.push(u.id),
          null == u.pid && null != u.stpid
            ? ((u = o[u.stpid]).min = !1)
            : (u = o[u.pid]);
    ...
    for (s = l.length - 1; 0 <= s; s--) l[s].collapsed && l.splice(s, 1);
    for (s = 0; s < _.length; s++) {
      ...
      for (m = 0; m < u.children.length; m++) {
        (T = u.children[m]).isAssistant
          ? w.push(T.id)
          : -1 != T.tags.indexOf("right-partner")
          ? ((T.isPartner = 1), (T.children = []), k.push(T.id))
          : -1 != T.tags.indexOf("left-partner")
          ? ((T.isPartner = 2), (T.children = []), S.push(T.id))
          : -1 == T.tags.indexOf("partner") || A % 2
          ? -1 != T.tags.indexOf("partner") && A % 2
            ? ((T.isPartner = 2), (T.children = []), S.push(T.id), A++)
            : T.parentPartner
            ? (I[T.parentPartner.id] || (I[T.parentPartner.id] = []),
              I[T.parentPartner.id].push(T.id))
            : w.push(T.id)
          : ((T.isPartner = 1), (T.children = []), k.push(T.id), A++);
      }
      u.children = [];
      for (m = 0; m < k.length; m++) {
        I[(T = o[k[m]]).id] ? u.children.push(T) : u.children.splice(0, 0, T);
      }
      for (m = 0; m < S.length; m++) {
        I[(T = o[S[m]]).id] ? u.children.push(T) : u.children.splice(0, 0, T);
      }
      for (m = S.length - 1; 0 <= m; m--)
        if (I[S[m]])
          for (p = 0; p < I[S[m]].length; p++)
            u.children.push(o[I[S[m]][p]]),
              E++,
              -1 == L.indexOf(S[m]) && L.push(S[m]);
      ...
      for (m = 0; m < k.length; m++)
        if (I[k[m]])
          for (p = 0; p < I[k[m]].length; p++)
            u.children.push(o[I[k[m]][p]]),
              M++,
              -1 == N.indexOf(k[m]) && N.push(k[m]);
      (u.partnerSeparation =
        Math.max(L.length, N.length) * t.partnerChildrenSplitSeparation +
    ...
    for (s = 0; s < v.length; s++) {
      if (
        (J = e[(u = o[v[s]]).lcn ? u.lcn : "base"]).layout == OrgChart.normal ||
        !b[u.pid]
      )
        for (m = 0; m < u.subLevels; m++) {
          var B,
            P = new OrgChart.node(
              u.id + "_sub_level_index_" + m,
              u.pid,
              [],
              "subLevel"
            );
          if ((OrgChart.manager._initDinamicNode(P, u.lcn), (K = u.parent)))
            -1 < (B = K.children.indexOf(u)) &&
              (K.children.splice(B, 1), K.children.splice(B, 0, P)),
              P.children.push(u),
              (P.parent = K),
              (o[(u.parent = P).id] = P);
        }
    ...
    for (var F in x) {
      (K = o[F]).hasAssistants = !0;
      P = new OrgChart.node(
        K.id + "_split_assitant_0",
        K.id,
        ["assistant"],
        "split"
      );
      OrgChart.manager._initDinamicNode(P, K.lcn, !0), (o[P.id] = P);
      var z = [];
      for (m = K.children.length - 1; 0 <= m; m--) {
        (T = K.children[m]).isAssistant
          ? ((T.parent = null), K.children.splice(m, 1), z.splice(0, 0, T.id))
          : T.isPartner ||
            (T.parent &&
              b[T.parent.id] &&
              P &&
              ...
              (Object.defineProperty(
                b,
                P.id,
                Object.getOwnPropertyDescriptor(b, T.parent.id)
              ),
              delete b[T.parent.id]),
            (T.parent = P).children.unshift(T),
            K.children.splice(m, 1));
      }
      if (z.length % 2) {
        var U = o[z[z.length - 1]],
          H = new OrgChart.node(U.id + "_mirror", U.pid, [], "mirror");
        OrgChart.manager._initDinamicNode(H, U.lcn, !0),
          (U._m = H.id),
          (H.isAssistant = !0),
          (H.w = U.w),
          (H.h = U.h),
          (o[H.id] = H),
          z.splice(z.length - 1, 0, H.id);
      }
      var j = 1;
      for (m = z.length - 1; 0 <= m; m--)
        if (m % 2 && m != z.length - 1) {
          var R = new OrgChart.node(
            K.id + "_split_assitant_" + j,
            null,
            [],
            "split"
          );
          OrgChart.manager._initDinamicNode(R, K.lcn, !0),
            (o[R.id] = R),
            z.splice(m, 0, R.id),
            j++;
        } else m % 2 && z.splice(m, 0, P.id);
      for (m = 0; m < z.length; m += 3) {
        var D = null;
        D = 0 == m ? K : o[z[m - 2]];
        var Y = o[z[m]],
          X = o[z[m + 1]],
    ...
    if (V) {
      var G = { nodes: o, config: t, action: r, actionParams: i };
      for (var F in b) {
        var K, J;
        if (
          (J = e[(K = o[F]).lcn ? K.lcn : "base"]).layout == OrgChart.mixed ||
          J.layout == OrgChart.tree ||
          J.layout == OrgChart.treeRightOffset ||
          J.layout == OrgChart.treeLeftOffset
        )
          if (
            ...
            (G.layout = J.layout),
            (G.childrenIds = b[F]),
            (G.lastChildrenPidIds = b),
            OrgChart.events.publish("layout", [G]),
            G.layout == OrgChart.mixed)
          ) {
            var Z = G.childrenIds;
            for (s = Z.length - 1; 0 <= s; s--) {
              (K = (T = o[Z[s]]).parent), (T.layout = OrgChart.mixed);
              for (m = K.children.length - 1; 0 <= m; m--)
                if (T.id == K.children[m].id) {
                  K.children.splice(m, 1);
                  break;
                }
              if (0 < s) {
                var Q = o[Z[s - 1]];
                (T.parent = Q), (T.layout = OrgChart.mixed), Q.children.push(T);
              } else K.children.push(T);
            }
          } else if (
            G.layout == OrgChart.tree ||
            G.layout == OrgChart.treeRightOffset ||
            G.layout == OrgChart.treeLeftOffset
          ) {
            P = new OrgChart.node(K.id + "_split_0", K.id, [], "split");
            OrgChart.manager._initDinamicNode(P, K.lcn),
              ((o[P.id] = P).layout = OrgChart.tree);
            var $ = [];
            for (s = G.childrenIds.length - 1; 0 <= s; s--) {
              for (T = o[G.childrenIds[s]], m = 0; m < K.children.length; m++)
                K.children[m].id == T.id && K.children.splice(m, 1);
              if (
                ((T.parent = null),
                (T.layout = OrgChart.tree),
                G.layout == OrgChart.treeRightOffset && $.splice(0, 0, T.id),
                G.layout == OrgChart.treeLeftOffset ||
                  G.layout == OrgChart.treeRightOffset)
              ) {
                var tt = new OrgChart.node(
                  T.id + "_mirror",
                  null,
                  [],
                  "mirror"
                );
                OrgChart.manager._initDinamicNode(tt, T.lcn),
                  (tt.layout = OrgChart.tree),
                  (o[tt.id] = tt),
                  $.splice(0, 0, tt.id);
              }
              G.layout != OrgChart.treeRightOffset && $.splice(0, 0, T.id);
            }
            for (j = 1, m = $.length - 1; 0 <= m; m--)
              if (m % 2 && m != $.length - 1) {
                R = new OrgChart.node(K.id + "_split_" + j, null, [], "split");
                OrgChart.manager._initDinamicNode(R, K.lcn),
                  (R.layout = OrgChart.tree),
                  (o[R.id] = R),
                  $.splice(m, 0, R.id),
                  j++;
              } else m % 2 && $.splice(m, 0, P.id);
            for (m = 0; m < $.length; m += 3) {
              D = null;
              0 == m && (D = K);
              (Y = o[$[m]]), (X = o[$[m + 1]]), (q = o[$[m + 2]]);
              0 != m && (D = o[$[m - 3]]),
                0 == m || X || (D = o[$[m - 2]]),
                (Y.parent = D).children.push(Y),
                X &&
                  (0 != m && (D = o[$[m - 2]]),
                  (X.parent = D).children.push(X)),
                q &&
                  (0 != m && (D = o[$[m - 1]]),
                  (q.parent = D).children.push(q));
            }
          }
      }
    }
    return { nodes: o, roots: l };
  }),
  ...
  (OrgChart.manager._getResponse = function (
    ...
    if (
      ...
      if (b - 2 * i.padding >= a - o)
        switch (((w = (a + o) / 2 - b / 2), i.orientation)) {
          case OrgChart.orientation.right:
          case OrgChart.orientation.right_top:
            w = (o - a) / 2 - b / 2;
        }
        ...
        switch (
          ((w = u.x - b / 2 + OrgChart.manager._getNodeWidth(u, i) / 2),
          i.orientation)
        ) {
          case OrgChart.orientation.right:
          case OrgChart.orientation.right_top:
            (w = -(b / 2 - (o - a) / 2)) < i.padding - b && (w = i.padding - b);
            break;
          case OrgChart.orientation.left:
          case OrgChart.orientation.bottom_left:
          case OrgChart.orientation.top_left:
          case OrgChart.orientation.left_top:
            (w = -(b / 2 - (a - o) / 2)) > -i.padding && (w = -i.padding);
        }
      ...
      (b = Math.ceil(t / v)), (_ = Math.ceil(e / v)), (w = 0), (k = 0);
      ...
      (s = [w, k, b, _]),
        i.sticky &&
          (s[0] < m.left &&
            s[0] < m.right &&
            (s[0] = m.left > m.right ? m.right : m.left),
          s[0] > m.right &&
            s[0] > m.left &&
            (s[0] = m.left > m.right ? m.left : m.right),
          s[1] < m.top &&
            s[1] < m.bottom &&
            (s[1] = m.top > m.bottom ? m.bottom : m.top),
          s[1] > m.bottom &&
            s[1] > m.top &&
            (s[1] = m.top > m.bottom ? m.top : m.bottom));
    }
    ...
    for (var E = 0; E < h.length; E++)
      OrgChart.manager._iterate2(h[E], g, i, s, d, c, C, p, r, O);
    return {
      animations: O,
      boundary: m,
      viewBox: s,
  ...
  (OrgChart.manager._iterate2 = function (t, e, r, i, a, n, o, l, s, h) {
    if (OrgChart.manager._isVisible(t, r, i, a)) {
      ...
      if (
        ...
        if ((u = e[n.id])) {
          ...
          c && (d = { x: u.x + u.w / 2 - t.w / 2, y: u.y + u.h / 2 - t.h / 2 });
        }
      } else if (
        ...
        if (((d = { x: (f = l[t.id]).x, y: f.y }), "all" == n.ids && f)) {
          d = { x: f.x, y: f.y };
        ...
        if (
          (null != (f = l[t.id]).x && null != f.y && (d = { x: f.x, y: f.y }),
          (p = e[n.id]) && p == t)
        )
          (c = t.parent) &&
            c.id == n.id &&
        ...
        if (
          (!(f = l[t.id]) ||
            (OrgChart.isNullOrEmpty(f.x) && OrgChart.isNullOrEmpty(f.y))) &&
          n
        ) {
          if ((u = e[n.id])) {
            for (c = u; c && c.id == t.id; ) c = c.parent;
            c && (d = { x: u.x, y: u.y });
          }
        } else d = { x: f.x, y: f.y };
      }
    ...
    for (var C = 0; C < t.stChildren.length; C++)
      OrgChart.manager._iterate2(t.stChildren[C], e, r, i, a, n, o, l, s, h);
    for (C = 0; C < t.children.length; C++)
      OrgChart.manager._iterate2(t.children[C], e, r, i, a, n, o, l, s, h);
  }),
  ...
  (OrgChart.templates.olivia.field_0 =
    "<text " +
    OrgChart.attr.width +
    '="145" style="font-size: 18px;" fill="#757575" x="100" y="55">{val}</text>'),
  (OrgChart.templates.olivia.field_1 =
    "<text " +
    OrgChart.attr.width +
    '="145" style="font-size: 14px;" fill="#757575" x="100" y="76">{val}</text>'),
  ...
  (OrgChart.templates.rony.field_0 =
    "<text " +
    OrgChart.attr.width +
    '="165" style="font-size: 18px; font-weight:bold;" fill="#739dc3" x="90" y="40" text-anchor="middle">{val}</text>'),
  ...
  (OrgChart.templates.rony.link =
    '<path stroke="#495866" stroke-width="3px" fill="none" d="M{xa},{ya} {xb},{yb} {xc},{yc} L{xd},{yd}"/>'),
  ...
  (OrgChart.templates.derek.field_0 =
    "<text " +
    OrgChart.attr.width +
    '="235" style="font-size: 24px;" fill="#aeaeae" x="125" y="90" text-anchor="middle">{val}</text>'),
  (OrgChart.templates.derek.field_1 =
    "<text " +
    OrgChart.attr.width +
    '="130" style="font-size: 16px;" fill="#aeaeae" x="230" y="30" text-anchor="end">{val}</text>'),
  ...
  (OrgChart.ui = {
    ...
    node: function (t, e, r, i, a, n, o, l, s, h) {
      ...
      var C = OrgChart._getPosition(r, t, a, n),
        m = "node";
    ...
    nodeBtns: function (t, e, r, i, a) {
      ...
      return (
        ...
        null == t.nodeCircleMenu ||
          e.isSplit ||
          r === OrgChart.action.exporting ||
          OrgChart.isNullOrEmpty(i.nodeCircleMenuButton) ||
          (n +=
    ...
    expandCollapseBtn: function (t, e, r, i, a) {
      ...
      if (i !== OrgChart.action.exporting && !e.isSplit) {
        ...
        if (0 < e.childrenIds.length) {
          if (e.hasPartners) {
            for (var d = !1, c = 0; c < e.children.length; c++)
              e.children[c].parentPartner ||
                e.children[c].isPartner ||
                (d = !0);
            if (!d) return "";
          }
    ...
    link: function (t, e, r, i, a, n) {
          ...
          (C = t.children[u]).parentPartner
            ? ((f.ppnodes[C.id] = C.parentPartner),
              ...
              1 == C.parentPartner.isPartner
                ? (-1 == f.rightIds.indexOf(C.parentPartner.id) &&
                    f.rightIds.push(C.parentPartner.id),
                  (f.indexes[C.id] = f.rightIds.indexOf(C.parentPartner.id)),
                  f.firstRight || (f.firstRight = C))
                : 2 == C.parentPartner.isPartner &&
                  (-1 == f.leftIds.indexOf(C.parentPartner.id) &&
                    f.leftIds.push(C.parentPartner.id),
                  (f.indexes[C.id] = f.leftIds.indexOf(C.parentPartner.id)),
                  (f.lastLeft = C)))
            : C.isPartner ||
              ((f.lastLeft = C), f.firstRight || (f.firstRight = C));
        }
      ...
      for (u = 0; u < t.children.length; u++) {
        var C = t.children[u],
          ...
          y = (s = OrgChart.t(C.templateName, C.min, r)).link;
        if (f && -1 != f.ids.indexOf(C.id))
          ...
          (C.isAssistant || 2 == C.layout) &&
          C.rightNeighbor &&
          C.rightNeighbor.isSplit
        )
          switch (l.orientation) {
            case OrgChart.orientation.top:
            case OrgChart.orientation.top_left:
              O = OrgChart.ui._linkRightToLeft(C.rightNeighbor, C, s, d);
              break;
            case OrgChart.orientation.bottom:
            case OrgChart.orientation.bottom_left:
              O = OrgChart.ui._linkRightToLeft(C.rightNeighbor, C, s, d);
            ...
            case OrgChart.orientation.right:
            case OrgChart.orientation.right_top:
              O = OrgChart.ui._linkBottomToTop(C.rightNeighbor, C, s, d);
              break;
            case OrgChart.orientation.left:
            case OrgChart.orientation.left_top:
              O = OrgChart.ui._linkBottomToTop(C.rightNeighbor, C, s, d);
          ...
          (C.isAssistant || 2 == C.layout) &&
          C.leftNeighbor &&
          C.leftNeighbor.isSplit
        )
          switch (l.orientation) {
            case OrgChart.orientation.top:
            case OrgChart.orientation.top_left:
              O = OrgChart.ui._linkLeftToRight(C.leftNeighbor, C, s, d);
              break;
            case OrgChart.orientation.bottom:
            case OrgChart.orientation.bottom_left:
              O = OrgChart.ui._linkLeftToRight(C.leftNeighbor, C, s, d);
            ...
            case OrgChart.orientation.right:
            case OrgChart.orientation.right_top:
              O = OrgChart.ui._linkTopToBottom(C.leftNeighbor, C, s, d);
              break;
            case OrgChart.orientation.left:
            case OrgChart.orientation.left_top:
              O = OrgChart.ui._linkTopToBottom(C.leftNeighbor, C, s, d);
          ...
          switch (l.orientation) {
            ...
            case OrgChart.orientation.top_left:
              if (1 == C.isPartner)
                O = OrgChart.ui._linkLeftToRight(t, C, s, c);
              else if (2 == C.isPartner)
                O = OrgChart.ui._linkRightToLeft(t, C, s, c);
              else {
                var x = 1 == C.layout ? void 0 : m.minY - (m.minY - p.maxY) / 2;
                O = OrgChart.ui._linkTopToBottom(t, C, s, d, x);
              }
              break;
            case OrgChart.orientation.bottom:
            case OrgChart.orientation.bottom_left:
              if (1 == C.isPartner)
                ...
                x = 1 == C.layout ? void 0 : m.maxY - (m.maxY - p.minY) / 2;
                O = OrgChart.ui._linkBottomToTop(t, C, s, d, x);
              }
              break;
            case OrgChart.orientation.right:
            case OrgChart.orientation.right_top:
              if (1 == C.isPartner)
                O = OrgChart.ui._linkTopToBottom(t, C, s, c);
              else if (2 == C.isPartner)
                O = OrgChart.ui._linkBottomToTop(t, C, s, c);
              else {
                x = 1 == C.layout ? void 0 : m.maxX - (m.maxX - p.minX) / 2;
                O = OrgChart.ui._linkRightToLeft(t, C, s, d, x);
              }
              break;
            case OrgChart.orientation.left:
            case OrgChart.orientation.left_top:
              if (1 == C.isPartner)
                ...
                x = 1 == C.layout ? void 0 : m.minX - (m.minX - p.maxX) / 2;
                O = OrgChart.ui._linkLeftToRight(t, C, s, d, x);
              }
          }
        if (-1 != y.indexOf("{rounded}"))
          if (
            (O.xa == O.xb && O.xa == O.xc && O.xa == O.xd) ||
            (O.ya == O.yb && O.ya == O.yc && O.ya == O.yd)
          )
            y = y.replace(
              "{rounded}",
              "M" + O.xa + "," + O.ya + " L" + O.xd + "," + O.yd
            );
          else {
        ...
        var _ = { node: t, cnode: C, p: O, html: y, action: n };
          ...
          if (I) {
            ...
            (_.value = A),
              ...
              !1 !== OrgChart.events.publish("label", [e, _]) &&
                (OrgChart.isNullOrEmpty(_.value) ||
                  OrgChart.isNullOrEmpty(_.element) ||
  ...
  (OrgChart.wrapText = function (t, e) {
    ...
    if (
      ...
      for (var u = p.getComputedTextLength(), C = 2; d < u; )
        (p.textContent = t.substring(0, t.length - C)),
          (p.textContent += "..."),
          (u = p.getComputedTextLength()),
          C++;
      return 2 < C ? "<title>" + t + "</title>" + p.textContent : t;
    }
    if (-1 != c.indexOf("multiline")) {
      var m = t.split(" "),
        O = p.getBBox().height;
      p.textContent = "";
      var y = document.createElementNS(g, "tspan"),
        x = document.createTextNode(m[0]);
      y.setAttributeNS(null, "x", l),
        y.setAttributeNS(null, "y", s),
        y.setAttributeNS(null, "text-anchor", h),
        y.appendChild(x),
        p.appendChild(y);
      C = 1;
      for (var v = 1, b = 1; b < m.length; b++) {
        var _ = y.firstChild.data.length;
        if (
          ((y.firstChild.data += " " + m[b]), y.getComputedTextLength() > d)
        ) {
          if (
            ((y.firstChild.data = y.firstChild.data.slice(0, _)),
            v++,
            a && a < v)
          ) {
          ...
          (y = document.createElementNS(g, "tspan")).setAttributeNS(
            null,
            "x",
            l
          ),
            y.setAttributeNS(null, "y", s + O * C),
            y.setAttributeNS(null, "text-anchor", h),
            (x = document.createTextNode(m[b])),
            y.appendChild(x),
            p.appendChild(y),
            C++;
        }
      ...
      if (null != p.innerHTML) (k = p.innerHTML), (p.innerHTML = "");
        ...
        var S = "";
        for (b = p.childNodes.length - 1; 0 <= b; b--)
          (S = XMLSerializer().serializeToString(p.childNodes[b]) + S),
            p.removeChild(p.childNodes[b]);
        k = S;
      }
      return k;
    }
  ...
  (OrgChart.prototype._slinks = function (S, t) {
    ...
    for (var r = 0; r < this.config.slinks.length; r++) {
      var M = this.config.slinks[r],
        i = S.getNode(M.from),
        a = S.getNode(M.to);
      i &&
        a &&
        -1 != t.res.visibleNodeIds.indexOf(a.id) &&
        -1 != t.res.visibleNodeIds.indexOf(i.id) &&
  ...
  OrgChart.events.on("init", function (t, e) {
    t.config.enableKeyNavigation &&
      ...
      OrgChart.isNullOrEmpty(t._keyNavigationActiveNodeId) &&
        t.roots &&
        t.roots.length &&
